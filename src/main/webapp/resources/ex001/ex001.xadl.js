(function()
{
    return function()
    {
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::frm_list.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::frm_list.xfdl");
        ...
        this.loadIncludeScript("ex001.xadl", true);
    };
}
)();
